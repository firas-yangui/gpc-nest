...
export const typeOrmConfig: TypeOrmModuleOptions = {
  ...
  username: process.env.DATABASE_USER || process.env.TYPEORM_USERNAME || 'gpc',
  password: process.env.DATABASE_PASSWORD || process.env.TYPEORM_PASSWORD || 'gpc',
  database: process.env.DATABASE_DB || process.env.TYPEORM_DATABASE || 'gpc',
