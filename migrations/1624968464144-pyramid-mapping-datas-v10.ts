...
export class pyramidMappingDatasV101624968464144 implements MigrationInterface {
    ...
    await queryRunner.query(`
        ...
        ('GSC/DAT/DAT/MGT','5555514913'),
        ('GSC/CRL/MGT/MGT','5555514928'),
        ('GSC/CFT/FIN/DIR','3000314922'),
        ('GSC/CFT/SCR/DIR','3000371917'),
        ('GSC/DAT/REF/ELR','5555514914'),
        ('GSC/CFT/ITO/DIR','3000314938'),
        ('GSC/FIN/BLR/ML','5555514922'),
        ('GSC/COO/COO/COO','5555514901'),
        ('GSC/DAT/REF/SKR','5555514914'),
        ('GSC/FIN/FIN/MGT','5555514924'),
        ('GSC/ARS/ARS/MGT','5555571917'),
        ('GSC/CFT/H2R/H2R','3000314934'),
        ('GSC/DAT/INX','5555514913'),
