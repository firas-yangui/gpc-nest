...
export class pyramidMappingDatasV121625477208495 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        ('EBS/CFT/H2R/ICA','3000314937'),
        ('EBS/CFT/DIR/DIR','3000371976'),
        ('CFT/H2R/AIR/ACH','3000372003'),
        ('CFT/H2R/CEA/CEA','3000372002'),
        ('CFT/H2R/AIR/AIR','3000372003'),
        ('CFT/H2R/AIR/IMM','3000372003');
            `);
        await queryRunner.query(`
